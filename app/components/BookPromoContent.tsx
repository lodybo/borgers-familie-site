  ...
  return (
    <div className="text-lg space-y-6">
      <div className="space-y-6">
        <p>
          Bertus Borgers (Vessem, 1947) schreef het verhaal van het muziek maken
          in zijn familie, vanaf september 1944 toen de Brabantse Kempen werd
          bevrijd, tot en met de rock, soul en blues show die de familie
        ...
        <p>
          ...
          gezicht geven en putte behalve uit eigen werk ook uit het archief van
          familie Borgers.
        </p>

        <p>
          Een aantal van die afbeeldingen zijn met een smartphone of tablet tot
          leven te brengen omdat zij d.m.v. Augmented Reality gekoppeld zijn aan
          een productie op internet. Eén daarvan is de cover van het boek,
          tevens de voorkant van deze flyer.
        </p>
      </div>
      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="text-base italic mt-8 pl-0 md:pl-5 space-y-4">
          <p>
            Beleef de toepassing van Augmented Reality en breng de cover van het
            boek tot leven!
          </p>
